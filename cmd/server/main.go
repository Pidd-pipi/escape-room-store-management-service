// Command server is the escape-room-ops backend entrypoint.
package main
...
import (
	...
	"github.com/lp/escape-room-ops/internal/router"
...
func main() {
	...
	if err := db.AutoMigrate(
		&model.User{}, &model.ThemeRoom{}, &model.GameSession{}, &model.SessionRegistration{},
		&model.Prop{}, &model.PropMaintenance{}, &model.EscapeRecord{}, &model.Revenue{},
	); err != nil {
	...
	go func() {
		logger.Info("escape-room-ops server listening", slog.String("port", cfg.Port))
